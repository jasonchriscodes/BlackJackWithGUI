...
public class Shoe implements CardContainer {
     ...
     *
     * <p>
     * A shoe is a device used to hold multiple decks of playing cards. The show
     * allows for more games to be played by reducing time between shuffles. In
     * blackjack, using multiple decks of cards can increase the house edge.
     *
